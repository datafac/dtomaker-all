...
//        [Fact] public async Task Generic1_VerifyGeneratedSource0() => await Verifier.Verify(source1.GenerateAndGetOutput(0, "DTOMaker.Runtime.JsonNewtonSoft.EntityBase.g.cs"));
//        [Fact] public async Task Generic1_VerifyGeneratedSource1() => await Verifier.Verify(source1.GenerateAndGetOutput(1, "MyOrg.Models.JsonNewtonSoft.MyDTO2.g.cs"));
//        [Fact] public async Task Generic1_VerifyGeneratedSource2() => await Verifier.Verify(source1.GenerateAndGetOutput(2, "MyOrg.Models.JsonNewtonSoft.MyDTO3.g.cs"));
//        [Fact] public async Task Generic1_VerifyGeneratedSource3() => await Verifier.Verify(source1.GenerateAndGetOutput(3, "MyOrg.Models.JsonNewtonSoft.Pair_2_Int64_String.g.cs"));
