...
//        [Fact] public async Task Generic1_VerifyGeneratedSource0() => await Verifier.Verify(source1.GenerateAndGetOutput(0, "DTOMaker.Runtime.MessagePack.EntityBase.g.cs"));
//        [Fact] public async Task Generic1_VerifyGeneratedSource1() => await Verifier.Verify(source1.GenerateAndGetOutput(1, "MyOrg.Models.MessagePack.MyDTO2.g.cs"));
//        [Fact] public async Task Generic1_VerifyGeneratedSource2() => await Verifier.Verify(source1.GenerateAndGetOutput(2, "MyOrg.Models.MessagePack.MyDTO3.g.cs"));
//        [Fact] public async Task Generic1_VerifyGeneratedSource3() => await Verifier.Verify(source1.GenerateAndGetOutput(3, "MyOrg.Models.MessagePack.Pair_2_Int64_String.g.cs"));
