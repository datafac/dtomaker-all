...
namespace DTOMaker.SrcGen.MessagePack.Tests
{
    public class InternalPipelineTests
    {
        ...
        //    // act
        //    var parsedEntities = SourceGeneratorBase.AddEntityBase(input, "MP2");

        //    // assert
        //    parsedEntities.Length.ShouldBe(4);
        //    parsedEntities[0].TFN.Intf.FullName.ShouldBe("DTOMaker.Runtime.IEntityBase");
        //    parsedEntities[0].TFN.Impl.FullName.ShouldBe("DTOMaker.Runtime.MP2.EntityBase");
        //    parsedEntities[0].TFN.ToString().ShouldBe("DTOMaker.Runtime.MP2.EntityBase : DTOMaker.Runtime.IEntityBase");
        ...
        //    parsedEntities[1].BaseTFN.ToString().ShouldBe("DTOMaker.Runtime.MP2.EntityBase : DTOMaker.Runtime.IEntityBase");
