        ...
        """
            ...
            namespace MyOrg.Models
            {
                ...
                public interface IMyDTO : IEntityBase
                {
                    ...
                    [Member(2, NativeType.Int32, typeof(DTOMaker.Models.DayOfWeekConverter))] DayOfWeek? Field2 { get; set; }
                }
            }
            """;

    [Fact] public void CustomSrcGen_GeneratedSourcesLength() => modelSource.GenerateAndCheckLength(1);
    [Fact] public async Task CustomSrcGen_VerifyGeneratedSource0() => await Verifier.Verify(modelSource.GenerateAndGetOutput(0, "MyOrg.Models.MsgPack2.MyDTO.g.cs"));
}
