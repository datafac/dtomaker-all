...
//        [Fact] public async Task Generic1_VerifyGeneratedSource0() => await Verifier.Verify(source1.GenerateAndGetOutput(0, "DTOMaker.Runtime.MemBlocks.EntityBase.g.cs"));
//        [Fact] public async Task Generic1_VerifyGeneratedSource1() => await Verifier.Verify(source1.GenerateAndGetOutput(1, "MyOrg.Models.MemBlocks.MyDTO2.g.cs"));
//        [Fact] public async Task Generic1_VerifyGeneratedSource2() => await Verifier.Verify(source1.GenerateAndGetOutput(2, "MyOrg.Models.MemBlocks.MyDTO3.g.cs"));
//        [Fact] public async Task Generic1_VerifyGeneratedSource3() => await Verifier.Verify(source1.GenerateAndGetOutput(3, "MyOrg.Models.MemBlocks.Pair_2_Int64_String.g.cs"));
...
//            grr.GeneratedSources[0].HintName.ShouldBe("MyOrg.Models.Monoid_1_Boolean.MemBlocks.g.cs");
//            grr.GeneratedSources[1].HintName.ShouldBe("MyOrg.Models.MyDTO.MemBlocks.g.cs");
//        }
...
//            grr.GeneratedSources[0].HintName.ShouldBe("MyOrg.Models.Monoid_1_Other.MemBlocks.g.cs");
//            grr.GeneratedSources[1].HintName.ShouldBe("MyOrg.Models.MyDTO.MemBlocks.g.cs");
//            grr.GeneratedSources[2].HintName.ShouldBe("MyOrg.Models.Other.MemBlocks.g.cs");
//        }
...
//            grr.GeneratedSources.Length.ShouldBe(2);
//            grr.GeneratedSources[0].HintName.ShouldBe("MyOrg.Models.MyTree.MemBlocks.g.cs");
//            grr.GeneratedSources[1].HintName.ShouldBe("MyOrg.Models.Tree_2_String_Octets.MemBlocks.g.cs");
//        }
...
//            grr.GeneratedSources[0].HintName.ShouldBe("MyOrg.Models.Base_1_Int64.MemBlocks.g.cs");
//            grr.GeneratedSources[1].HintName.ShouldBe("MyOrg.Models.Base_1_Octets.MemBlocks.g.cs");
//            grr.GeneratedSources[2].HintName.ShouldBe("MyOrg.Models.MyPoco1.MemBlocks.g.cs");
//            grr.GeneratedSources[3].HintName.ShouldBe("MyOrg.Models.MyPoco2.MemBlocks.g.cs");
//            grr.GeneratedSources[4].HintName.ShouldBe("MyOrg.Models.Poco_2_String_Int64.MemBlocks.g.cs");
//            grr.GeneratedSources[5].HintName.ShouldBe("MyOrg.Models.Poco_2_String_Octets.MemBlocks.g.cs");
//        }
