...
public partial class EntityGenerator
{
    protected override void OnGenerate(OutputEntity entity)
    {
        ...
        if (false)
        {
            ...
            Emit("        {");
            Emit("            EntityContent content = EntityContent.FromSingleBuffer(_metadata, buffer);");
            Emit("            return new T_MemberTypeImplName_(content);");
            Emit("        }");
            ...
            Emit("        }");
            Emit("        protected T_MemberTypeImplName_(EntityMetadata metadata, EntityContent content) : base(metadata, content)");
            Emit("        {");
            Emit("            var sourceBlock = content.Buffers[ClassHeight];");
            ...
            Emit("            }");
            Emit("        }");
            Emit("        public T_MemberTypeImplName_(EntityContent content) : this(_metadata, content) { }");
            Emit("        public T_MemberTypeImplName_(ReadOnlyMemory<byte> buffer) : this(EntityContent.FromSingleBuffer(_metadata, buffer)) { }");
            Emit("");
            ...
            Emit("        protected override void OnGetBuffers(Span<ReadOnlyMemory<byte>> buffers)");
            Emit("        {");
            Emit("            base.OnGetBuffers(buffers);");
            Emit("            buffers[ClassHeight] = _readonlyLocalBlock;");
            Emit("        }");
            Emit("");
            ...
            Emit("{");
            Emit("    public class T_BaseImplName_ : EntityBase, T_BaseIntfNameSpace_.T_BaseIntfName_, IEquatable<T_BaseImplName_>, IMemBlocksEntity<T_BaseImplName_>");
            Emit("    {");
            ...
            Emit("        {");
            Emit("            var metadata = EntityMetadata.Decode(buffer);");
            ...
            Emit("        }");
            Emit("");
            Emit("        protected T_BaseImplName_(EntityMetadata metadata, EntityContent content) : base(metadata, content)");
            Emit("        {");
            Emit("            var sourceBlock = content.Buffers[ClassHeight];");
            Emit("            if (sourceBlock.Length < BlockLength)");
            Emit("            {");
            ...
            Emit("        }");
            Emit("");
            Emit("        public T_BaseImplName_(EntityContent content) : this(_metadata, content) { }");
            Emit("        public T_BaseImplName_(ReadOnlyMemory<byte> buffer) : this(EntityContent.FromSingleBuffer(_metadata, buffer)) { }");
            Emit("");
        ...
        Emit("        /// </summary>");
        Emit("        protected T_EntityImplName_(EntityMetadata metadata, EntityContent content) : base(metadata, content)");
        Emit("        {");
        Emit("            var sourceBlock = content.Buffers[ClassHeight];");
        Emit("            if (sourceBlock.Length < BlockLength)");
        Emit("            {");
        ...
        Emit("");
        Emit("        /// <summary>");
        Emit("        /// Creates a new instance of the T_EntityImplName_ entity by deserializing the content buffers.");
        Emit("        /// </summary>");
        Emit("        public T_EntityImplName_(EntityContent content) : this(_metadata, content) { }");
        Emit("");
        Emit("        /// <summary>");
        Emit("        /// Creates a new instance of the T_EntityImplName_ entity by deserializing the received buffer.");
        Emit("        /// </summary>");
        Emit("        public T_EntityImplName_(ReadOnlyMemory<byte> buffer) : this(_metadata, EntityContent.FromSingleBuffer(_metadata, buffer)) { }");
        Emit("");
        if (false)
        {
            ...
            switch (member.Kind)
            {
                ...
                case MemberKind.Entity:
                    if (member.IsNullable)
                    {
                        ...
                        Emit("                var buffers = _T_NullableEntityMemberName_.GetContent();");
                        Emit("                BlobIdV1 blobId = await dataStore.PutBlob(buffers.ToSingleBuffer());");
                        ...
                        Emit("            if (blob.HasData)");
                        Emit("            {");
                        Emit("                _T_NullableEntityMemberName_ = T_MemberTypeImplSpace_.T_MemberTypeImplName_.DeserializeFrom(blob.Data);");
                    ...
                    else
                    {
                        ...
                        Emit("            var content = _T_RequiredEntityMemberName_.GetContent();");
                        Emit("            BlobIdV1 blobId = await dataStore.PutBlob(content.ToSingleBuffer());");
                        ...
                        Emit("            if (blob.HasData)");
                        Emit("            {");
                        Emit("                _T_RequiredEntityMemberName_ = T_MemberTypeImplSpace_.T_MemberTypeImplName_.DeserializeFrom(blob.Data);");
                ...
                case MemberKind.Binary:
                    if (member.IsNullable)
                    {
                        ...
                        Emit("            else");
                        Emit("            {");
                        Emit("                BlobIdV1 blobId = await dataStore.PutBlob(_T_NullableBinaryMemberName_.AsMemory());");
                        ...
                        Emit("            var blob = await dataStore.GetBlob(blobId);");
                        Emit("            _T_NullableBinaryMemberName_ = blob.HasData ? Octets.Wrap(blob.Data) : null;");
                        Emit("        }");
                    ...
                    else
                    {
                        ...
                        Emit("        {");
                        Emit("            var buffers = _T_RequiredBinaryMemberName_.AsMemory();");
                        ...
                        Emit("            var blob = await dataStore.GetBlob(blobId);");
                        Emit("            _T_RequiredBinaryMemberName_ = blob.HasData ? Octets.Wrap(blob.Data) : Octets.Empty;");
                        Emit("");
                        Emit("        }");
                ...
                case MemberKind.String:
                    if (member.IsNullable)
                    {
                        ...
                        Emit("            _T_NullableStringMemberName_ = blob.HasData ? System.Text.Encoding.UTF8.GetString(blob.Data.Span) : null;");
                        Emit("#else");
                        Emit("            _T_NullableStringMemberName_ = blob.HasData ? System.Text.Encoding.UTF8.GetString(blob.Data.ToArray()) : null;");
                        Emit("#endif");
                        Emit("        }");
                    ...
                    else
                    {
                        ...
                        Emit("            var blob = await dataStore.GetBlob(blobId);");
                        Emit("#if NET8_0_OR_GREATER");
                        Emit("            _T_RequiredStringMemberName_ = blob.HasData ? System.Text.Encoding.UTF8.GetString(blob.Data.Span) : string.Empty;");
                        Emit("#else");
                        Emit("            _T_RequiredStringMemberName_ = blob.HasData ? System.Text.Encoding.UTF8.GetString(blob.Data.ToArray()) : string.Empty;");
                        Emit("#endif");
                        Emit("        }");
        ...
        Emit("            var span = _readonlyLocalBlock.Span;");
        Emit("            result.Add(span.Length);");
        Emit("#if NET8_0_OR_GREATER");
        Emit("            result.AddBytes(span);");
        Emit("#else");
        Emit("            for (int i = 0; i < span.Length; i++)");
        Emit("            {");
        Emit("                result.Add(span[i]);");
        Emit("            }");
        Emit("#endif");
