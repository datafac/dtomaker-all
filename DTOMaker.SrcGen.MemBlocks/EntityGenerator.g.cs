...
public partial class EntityGenerator
{
    protected override void OnGenerate(OutputEntity entity)
    {
        ...
        Emit("// <copyright>");
        Emit("//     Copyright (c) [yyyy]. All rights reserved by [name of copyright owner].");
        Emit("// </copyright>");
        Emit("// <auto-generated>");
        ...
        Emit("//");
        Emit("//     The use of DTOMaker source generators are subject to the End User License Agreement which can be found");
        Emit("//     at: https://github.com/datafac/dtomaker-all/blob/main/OSMFEULA.txt. This agreement includes a small payment");
        Emit("//     of an Open Source Maintenance Fee (OSMF) for organisations generating revenue above defined thresholds.");
        Emit("//     For more information about OSMF refer to: https://opensourcemaintenancefee.org/");
        Emit("// </auto-generated>");
