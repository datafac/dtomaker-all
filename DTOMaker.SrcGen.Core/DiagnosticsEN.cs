...
namespace DTOMaker.SrcGen.Core
{
    ...
    internal static class DiagnosticsEN
    {
        ...
        public static readonly DiagnosticDescriptor DME08 = Create(DiagnosticSeverity.Error, DiagnosticCategory.Design, nameof(DME08), "Invalid nullability",    "Nullable<T> fields are not supported in MemBlocks.");
